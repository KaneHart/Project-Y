...
recipes.addShaped(<immersiveengineering:conveyor>.withTag({conveyorType: "immersiveengineering:conveyor"}) * 4, [[null, null, null],[<minecraft:leather>, <minecraft:leather>, <minecraft:leather>], [<ic2:plate:7>, <charset:logic_wire_b:1>, <ic2:plate:7>]]);
...
//iron grit to 7 nuggets
mods.immersiveengineering.ArcFurnace.addRecipe(<immersiveengineering:metal:29> * 7, <immersiveengineering:metal:18>, <minecraft:gravel>, 120,  2048, []);
//gold grit to 7 nuggets
mods.immersiveengineering.ArcFurnace.addRecipe(<minecraft:gold_nugget> * 7, <immersiveengineering:metal:19>, <minecraft:gravel>, 120,  2048, []);
//copper grit to 7 nuggets
mods.immersiveengineering.ArcFurnace.addRecipe(<techreborn:nuggets:4> * 7, <immersiveengineering:metal:9>, <minecraft:gravel>, 120,  2048, []);
//lead grit to 7 nuggets
mods.immersiveengineering.ArcFurnace.addRecipe(<techreborn:nuggets:8> * 7, <immersiveengineering:metal:11>, <minecraft:gravel>, 120,  2048, []);
//silver grit to 7 nuggets
mods.immersiveengineering.ArcFurnace.addRecipe(<techreborn:nuggets:11> * 7, <immersiveengineering:metal:12>, <minecraft:gravel>, 120,  2048, []);
//uranium grit to 7 nuggets
mods.immersiveengineering.ArcFurnace.addRecipe(<immersiveengineering:metal:25> * 7, <immersiveengineering:metal:14>, <minecraft:gravel>, 120,  2048, []);
//tin grit to 7 nuggets
mods.immersiveengineering.ArcFurnace.addRecipe(<techreborn:nuggets:13> * 7, <missingmaterialsmod:tin_grit>, <minecraft:gravel>, 120,  2048, []);
